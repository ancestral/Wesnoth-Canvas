...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" language="javascript" src="scripts/map.js"></script>
  	...
  	<script type="text/javascript" language="javascript" src="scripts/hash.js"></script>
  ...
  <body onkeydown="keyDown(event)">
    <div id="container" style="padding: 8px;">
      <header>
        ...
        <div id="hex">&nbsp;</div>
        <textarea id="code">Paste the text from your Wesnoth map file into this box.</textarea>
      </header>
